...
function mc0(){window.open("file/mc/1.15.2MCDR服务端(fabric).rar")}
function mc1(){window.open("file/mc/1.16.1MCDR服务端(fabric).rar")}
function mc2(){window.open("file/mc/1.16.1(fabric)服务端.rar")}